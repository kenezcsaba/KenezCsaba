...
class L2Wood : MonoBehaviour
{
    [SerializeField] SpriteRenderer highlight;
    [SerializeField] bool isHit;
    [SerializeField] GameObject turnOnWhenSolved; 
    float scaleX;
    float hittingX;
    ...
    void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        Goal colliderGoal = collision.gameObject.GetComponent<Goal>();
        if (colliderGoal!=null)
        {
            turnOnWhenSolved.SetActive(true);
        }
